let skill = document.getElementById("third-box-first-line");
let skill2 = document.getElementById("third-box-second-line");
let count =0;
function render(){
    let skillList = JSON.parse(localStorage.getItem("skillList_01")) || [];
